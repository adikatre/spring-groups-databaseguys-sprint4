...
/// initalization method
    ...
    public static Person[] init() {
        ...
        List<Map<String, Object>> personData = Arrays.asList(
            ...
            Map.ofEntries(
                Map.entry("name", "Indy Technologist"),
                Map.entry("uid", "indy"),
                Map.entry("email", "indy@gmail.com"),
                Map.entry("password", defaultPassword),
                Map.entry("sid", "100"),
                Map.entry("pfp", "/images/default.png"),
                Map.entry("kasmServerNeeded", false),
                Map.entry("roles", Arrays.asList("ROLE_USER", "ROLE_STUDENT")),
                Map.entry("stocks", "BTC")
            ),
            Map.ofEntries(
                Map.entry("name", "Salem Scrummer"),
                Map.entry("uid", "salem"),
                Map.entry("email", "salem@gmail.com"),
                Map.entry("password", defaultPassword),
                Map.entry("sid", "101"),
                Map.entry("pfp", "/images/default.png"),
                Map.entry("kasmServerNeeded", false),
            ...
            Map.ofEntries(
                Map.entry("name", "Phoenix Planner"),
                Map.entry("uid", "phoenix"),
                Map.entry("email", "phoenix@gmail.com"),
                Map.entry("password", defaultPassword),
                Map.entry("sid", "102"),
                Map.entry("pfp", "/images/default.png"),
                Map.entry("kasmServerNeeded", false),
            ...
            Map.ofEntries(
                Map.entry("name", "Cody Closer"),
                Map.entry("uid", "cody"),
                Map.entry("email", "cody@gmail.com"),
                Map.entry("password", defaultPassword),
                Map.entry("sid", "103"),
                Map.entry("pfp", "/images/default.png"),
                Map.entry("kasmServerNeeded", false),
            ...
            Map.ofEntries(
                Map.entry("name", "Pixel Gamer"),
                Map.entry("uid", "pixel"),
                Map.entry("email", "pixel@gmail.com"),
                Map.entry("password", defaultPassword),
                Map.entry("sid", "104"),
                Map.entry("pfp", "/images/default.png"),
                Map.entry("kasmServerNeeded", false),
            ...
            Map.ofEntries(
                Map.entry("name", "Cadence Musician"),
                Map.entry("uid", "cadence"),
                Map.entry("email", "cadence@gmail.com"),
                Map.entry("password", defaultPassword),
                Map.entry("sid", "105"),
                Map.entry("pfp", "/images/default.png"),
                Map.entry("kasmServerNeeded", false),
            ...
            Map.ofEntries(
                Map.entry("name", "Ace Athlete"),
                Map.entry("uid", "ace"),
                Map.entry("email", "ace@gmail.com"),
                Map.entry("password", defaultPassword),
                Map.entry("sid", "106"),
                Map.entry("pfp", "/images/default.png"),
                Map.entry("kasmServerNeeded", false),
            ...
            Map.ofEntries(
                Map.entry("name", "Marco Explorer"),
                Map.entry("uid", "marco"),
                Map.entry("email", "marco@gmail.com"),
                Map.entry("password", defaultPassword),
                Map.entry("sid", "107"),
                Map.entry("pfp", "/images/default.png"),
                Map.entry("kasmServerNeeded", false),
